...
from .cli_parsing import MyArgumentParser, SmartFormatter
...
DEFAULT_FONT_HALIGN = DEFAULT_FONT_HALIGN
DEFAULT_FONT_VALIGN = DEFAULT_FONT_VALIGN
...
# PLATFORM is provided by tesla_dashcam.constants
...
if PLATFORM == "darwin" and PROCESSOR == "i386":
    try:
        ...
        # When running under Rosetta, Python may report i386 even on Apple Silicon.
        cpu_brand = (sysctl.stdout or "").strip()
        if cpu_brand.lower().startswith("apple"):
            PROCESSOR = "arm64"
